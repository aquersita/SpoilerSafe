    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'account':
                return (
                    <div className="space-y-6">
                        <h2 className="text-xl font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">Detalles de la Cuenta</h2>

                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-500 uppercase tracking-widest">Nombre de Usuario</label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-500 uppercase tracking-widest">Biografía</label>
                            <textarea
                                rows={3}
                                className="bg-slate-50 border border-slate-200 text-slate-900 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary block w-full p-3 font-medium outline-none transition-shadow resize-none"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-500 uppercase tracking-widest">Ubicación</label>
                            <input
                                type="text"
                                className="bg-slate-50 border border-slate-200 text-slate-900 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary block w-full p-3 font-medium outline-none transition-shadow"
            ...
            case 'notifications':
                return (
                    <div className="space-y-6">
                        <h2 className="text-xl font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">Preferencias de Notificaciones</h2>

                        <div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-lg">
                            <div>
                                <h3 className="font-bold text-slate-800">Nuevos Episodios</h3>
                                <p className="text-sm text-slate-500">Avisarme cuando salga un episodio de mis animes en emisión.</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-lg">
                            <div>
                                <h3 className="font-bold text-slate-800">Actualidad de SpoilerSafe</h3>
                                <p className="text-sm text-slate-500">Recibir noticias sobre nuevas características de la plataforma.</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
            ...
            case 'spoilers':
                return (
                    <div className="space-y-6">
                        <h2 className="text-xl font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">Configuración Anti-Spoilers</h2>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-500 uppercase tracking-widest">Nivel de Bloqueo</label>
                            <select className="bg-slate-50 border border-slate-200 text-slate-900 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary block w-full p-3 font-medium cursor-pointer outline-none transition-shadow">
                        ...
                        <div className="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-orange-100 to-orange-50 border border-orange-200 rounded-xl text-center">
                            {currentUser?.is_premium ? (
                                <>
                                    ...
                                    <p className="text-slate-600 mb-6 max-w-sm">Estás disfrutando de anime en su máxima expresión. Sin anuncios sociales y a la mejor resolución posible.</p>
                                ...
                                <>
                                    ...
                                    <h3 className="text-2xl font-black text-slate-900 mb-2">Usuario Gratuito</h3>
                                    <p className="text-slate-600 mb-6 max-w-sm">Mejora a Premium para disfrutar de anime sin anuncios, descargas offline y emblemas exclusivos en tu perfil.</p>
                                    <button onClick={() => navigate('/premium')} className="bg-slate-900 hover:bg-slate-800 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-transform transform hover:scale-105">
                                        Subir a Premium
                                    </button>
                                </>
        ...
        <div className="min-h-screen bg-gray-50 p-6 md:p-12">
            <div className="max-w-4xl mx-auto">
                <div className="mb-10">
                    ...
                    <p className="text-slate-500 mt-2 text-lg">Administra la configuración de tu cuenta y preferencias de SpoilerSafe.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            {[
                                ...
                                <li
                                    ...
                                    className={`px-6 py-4 cursor-pointer transition-colors font-bold flex items-center gap-3
                                        ...
                                        ${activeTab === id ? 'bg-orange-50/50 text-primary border-l-4 border-l-primary' : 'hover:bg-slate-50 text-slate-700'}`}
                                >
                    ...
                    <div className="md:col-span-2 bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                        {renderContent()}
                    </div>
                </div>
            </div>
