            ...
            <div className="max-w-[1200px] mx-auto px-6">
                ...
                {history.length === 0 ? (
                    <div className="bg-white border-2 border-dashed border-gray-200 rounded-xl p-16 text-center">
                        ...
                        <h3 className="text-xl font-black text-gray-900 mb-2">Tu historial está vacío</h3>
                        <p className="text-gray-500 mb-6">Navega por el catálogo y entra en animes para que aparezcan aquí.</p>
                    ...
                    <div className="space-y-3">
                        {history.map((item, i) => (
                            <div key={i} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex group">
                                <div className="w-20 md:w-28 shrink-0 cursor-pointer bg-gray-100"
                                ...
                                <div className="flex-1 p-4 flex items-center justify-between min-w-0">
                                    <div className="min-w-0 flex-1">
                                        <h3 className="font-bold text-gray-900 text-sm truncate cursor-pointer hover:text-primary transition-colors"
                                            onClick={() => navigate(item.path)}>
                                            {item.title}
                                        </h3>
                                    ...
                                    <div className="flex items-center gap-2 ml-3">
                                        <button onClick={() => navigate(item.path)}
                                            className="bg-gray-100 hover:bg-primary hover:text-white text-gray-500 p-2 rounded-lg transition-colors">
